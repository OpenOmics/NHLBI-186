...
subtitle: "Session 1: Differential Expression Analysis (DESeq2)"
date: "`r Sys.Date()`"
...
knitr::opts_chunk$set(warning = T, message = F,echo = F) 
```
...
# Input dataframe {.tabset}

```{r read input expr pheno}
exps = readRDS('../data/expression.rds')
pheno = readRDS('../data/phenotype.rds')
...
```{r save image}
save.image(file = "../data/Session1.DGE_analysis_deseq2.RData")
```
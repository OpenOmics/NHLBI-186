...
subtitle: "Session 1: Differential Expression Analysis (DESeq2) using P4_24h and P4_72h"
date: "`r Sys.Date()`"
...
pheno = subset(pheno, (PatientID == 'Patient4' & Measurements == 'Ac_24h') | (PatientID == 'Patient4' & Measurements == 'Ac_72h'))
...
dds = DESeqDataSetFromMatrix(countData =exps.f,
                             colData = pheno,
                             design = formula(~ Measurements + Conditions))
# set reference level
